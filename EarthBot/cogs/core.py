...
class Core(commands.Cog):
    ...
    async def info(self, ctx):
        ...
        e.add_field(name="Developers", value="<@450678229192278036>: `e.info`, AutoPublish, `e.say`, `e.ping`, `e.uptime`, `e.userinfo`\n<@598325949808771083>: `e.help`", inline=False)
        if luckyint == 69:
            e.set_field_at(0, name="Developers", value="<@450678229192278036>: `e.info`, AutoPublish, `e.arth`, `e.say`, `e.ping`, `e.uptime`, `e.userinfo`\n<@598325949808771083>: `e.help`", inline=False)
        e.add_field(name="Versions", value=f"Earth: v1.0.0\ndiscord.py: v{discord.__version__}", inline=False)
