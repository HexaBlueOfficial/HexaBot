...
class Core(commands.Cog):
    ...
    async def info(self, ctx: commands.Context):
        ...
        e.add_field(name="Developers", value="<@450678229192278036>: All commands (except `e.help`), AutoPublish, AutoPing, and their Slash equivalents.\n<@598325949808771083>: `e.help`.\nOther: `e.jishaku` (External Extension).", inline=False)
        if luckyint == 69:
            e.set_field_at(0, name="Developers", value="<@450678229192278036>: All commands (except `e.help`), including `e.arth` (not available in Slash), AutoPublish, AutoPing, and their Slash equivalents.\n<@598325949808771083>: `e.help`.\nOther: `e.jishaku` (External Extension).", inline=False)
